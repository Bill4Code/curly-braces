...
@section('content')
    <section id="accueil" class="w-full h-screen grid place-items-center">
        <div class="flex items-center justify-center flex-col gap-y-5 max-sm:px-2">
            ...
            <a class="block w-40 text-center py-2 bg-custom-purple-900 text-white hover:bg-custom-red-900 duration-75 ease-in rounded" href="#">Prendre RDV</a>
        </div>
    </section>
    ...
    {{-- <section id="offres" class="w-full bg-custom-purple-900 px-20 lg:px-5 max-lg:px-5 pb-20">
        ...
        <div class="w-full grid grid-cols-2 gap-x-10">
            ...
            <article class="grid grid-cols-2 gap-10">
                <div class="h-[18em] rounded-lg flex items-center justify-center flex-col px-5 gap-y-3 bg-custom-red-900 text-white">
                    <div class="w-16">
